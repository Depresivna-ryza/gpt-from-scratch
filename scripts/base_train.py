...
parser.add_argument("--max-seq-len", type=int, default=64, help="max context length")
...
parser.add_argument("--num-iterations", type=int, default=800, help="explicit number of optimization steps (-1 = disable)")
...
parser.add_argument("--sample-every", type=int, default=200, help="sample from model every N steps (-1 = disable)")
